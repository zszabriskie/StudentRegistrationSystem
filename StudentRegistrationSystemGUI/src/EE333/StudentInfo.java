...
public class StudentInfo {
    ...
    // Constructor
    public StudentInfo(String FirstName, String LastName, String Email, UserLevel Level, boolean Contact) {
    ...
    public String toCustom(){
        return "Name: " + FirstName + "LastName: " + LastName + " ID: " + ID + " Email: " + Email;
    }
